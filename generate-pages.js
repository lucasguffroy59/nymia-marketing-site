...
<head>
    ...
    <style>
        * {
        ...
        .calendar-feature .feature-check {
            flex-shrink: 0;
            margin-top: 0;
        }
...
<body>
    ...
    <main>
        ...
        <section class="hero">
            <div class="container">
                ...
                <div class="store-buttons">
                    <a href="https://apps.apple.com/app/nymia-safe-period-protection/id6758914725" class="store-btn" aria-label="${t.hero.appStoreLabel[lang]}">
                        <svg viewBox="0 0 24 24" fill="currentColor">
                            <path d="M18.71 19.5C17.88 20.74 17 21.95 15.66 21.97C14.32 22 13.89 21.18 12.37 21.18C10.84 21.18 10.37 21.95 9.1 22C7.79 22.05 6.8 20.68 5.96 19.47C4.25 17 2.94 12.45 4.7 9.39C5.57 7.87 7.13 6.91 8.82 6.88C10.1 6.86 11.32 7.75 12.11 7.75C12.89 7.75 14.37 6.68 15.92 6.84C16.57 6.87 18.39 7.1 19.56 8.82C19.47 8.88 17.39 10.1 17.41 12.63C17.44 15.65 20.06 16.66 20.09 16.67C20.06 16.74 19.67 18.11 18.71 19.5M13 3.5C13.73 2.67 14.94 2.04 15.94 2C16.07 3.17 15.6 4.35 14.9 5.19C14.21 6.04 13.07 6.7 11.95 6.61C11.8 5.46 12.36 4.26 13 3.5Z"/>
                        </svg>
                        App Store
                    </a>
                    <a href="https://play.google.com/store/apps/details?id=com.nymia.app" class="store-btn" aria-label="${t.hero.playStoreLabel[lang]}">
                        <svg viewBox="0 0 24 24" fill="currentColor">
        ...
        <section class="calendar">
            <div class="container">
                <h2 class="section-title">${t.calendar.title[lang]}</h2>
                <p class="calendar-intro">${t.calendar.intro[lang]}</p>
                <div class="calendar-features">
                    <div class="calendar-feature">
                        <div class="feature-check" aria-hidden="true">✓</div>
                        <div>
                            <strong>${t.calendar.feature1Title[lang]}</strong>
                            <p>${t.calendar.feature1Desc[lang]}</p>
                        </div>
                    </div>
                    <div class="calendar-feature">
                        <div class="feature-check" aria-hidden="true">✓</div>
                        <div>
                            <strong>${t.calendar.feature2Title[lang]}</strong>
                            <p>${t.calendar.feature2Desc[lang]}</p>
                        </div>
                    </div>
                    <div class="calendar-feature">
                        <div class="feature-check" aria-hidden="true">✓</div>
                        <div>
                            <strong>${t.calendar.feature3Title[lang]}</strong>
                            <p>${t.calendar.feature3Desc[lang]}</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="features">
            <div class="container">
                ...
                <div class="features-list">
                    ...
                    <div class="feature-item">
                        <div class="feature-check" aria-hidden="true">✓</div>
                        <p>${t.features.feature7[lang]}</p>
                    </div>
                    
                    <div class="feature-item">
                        <div class="feature-check" aria-hidden="true">✓</div>
                        <p>${t.features.feature8[lang]}</p>
                    </div>
                </div>
            </div>
        </section>
        ...
        <!-- Health Library Section -->
        <section class="health-library">
            <div class="container">
                <h2 class="section-title">${t.healthLibrary.title[lang]}</h2>
                <p class="library-intro">${t.healthLibrary.intro[lang]}</p>
                <div class="library-topics">
                    <div class="topic-card">
                        <div class="topic-icon">🩺</div>
                        <p>${t.healthLibrary.topic1[lang]}</p>
                    </div>
                    <div class="topic-card">
                        <div class="topic-icon">🌙</div>
                        <p>${t.healthLibrary.topic2[lang]}</p>
                    </div>
                    <div class="topic-card">
                        <div class="topic-icon">📖</div>
                        <p>${t.healthLibrary.topic3[lang]}</p>
                    </div>
                </div>
                <p class="library-offline">${t.healthLibrary.offline[lang]}</p>
            </div>
        </section>
